...
/**
 *  \file       core/modules/pricematrix/doc/pdf_standard.modules.php
 *  \ingroup    pricematrix
...
/**
 *	Class to manage PDF template standard_projectmetrices
 */
class pdf_standard_projectmetrices extends ModelePDFProjectMetrices
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_PROJECTMETRICES_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->pricematrix->dir_output.'/projectmetrices') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->pricematrix->dir_output.'/projectmetrices';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->pricematrix->dir_output.'/projectmetrices/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('PRICEMATRIX_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('PRICEMATRIX_DRAFT_WATERMARK')));
		}
