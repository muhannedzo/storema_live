...
/**
 * \file    test/phpunit/PriceMatrixFunctionalTest.php
 * \ingroup pricematrix
...
/**
 * Class PriceMatrixFunctionalTest
 *
 ...
 *
 * @package Testpricematrix
 */
class PriceMatrixFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modPriceMatrix')->click();
		} else {
			// Disable the module
			$this->byHref('modPriceMatrix')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/pricematrix/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('pricematrix/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/pricematrix/admin/about.php');
		$this->authenticate();
		return $this->assertContains('pricematrix/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('pricematrixwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPriceMatrix_PriceMatrixTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPriceMatrix_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
