...
/**
 * \file    test/phpunit/StoresFunctionalTest.php
 * \ingroup stores
 ...
 * @package Teststores
 */
class StoresFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/stores/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('stores/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/stores/admin/about.php');
		$this->authenticate();
		return $this->assertContains('stores/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('storeswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modStores_StoresTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modStores_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
